...
export default function Home() {
  const buttonStyle =
    "flex transition-colors duration-700 ease-in-out delay-150 border border-transparent rounded-lg py-4";
  return (
    <div className="flex flex-col items-center max-w-screen-xl min-h-screen py-8 mx-auto lg:grid lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 font-Montserrat md:pt-28 pt-28">
      <div className=" place-self-center lg:col-span-6">
        ...
        <p className="max-w-2xl mb-6 text-justify text-gray-500 lg:mb-8 md:text-lg lg:text-xl">
        ...
        <Link to={"/leaderboard"}>
          <div
            className={`w-6/12 justify-center font-medium tracking-wider text-white bg-teal-900 hover:bg-white md:text-xl border-2 hover:border-teal-900 hover:text-teal-900 ${buttonStyle}`}
          >
            Leaderboard
          </div>
        </Link>
