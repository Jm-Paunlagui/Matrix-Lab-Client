...
import {
    ...
    faCaretRight,
    faFileCsv,
    faFileArrowDown, faTrash, faRotate, faUpLong, faDownLong,
...
export default function ManagementFilesCSV() {
  ...
  const { massRestore, textChangeRestore, massDelete, textChangeDelete, massPublish, textChangePublish, massUnpublished, textChangeUnpublished } = loadingAnimation;
  /**
  ...
  const handleDeleteAll = () => {
    ...
    httpClient.put("/data/delete-csv-file-all").then((response) => {
        loadFiles(page_number, per_page_limit);
        setLoadingAnimation({
            ...loadingAnimation,
            massDelete: false,
  ...
  const handleRestoreAll = () => {
    ...
    httpClient.put("/data/unflag-all-delete-csv-file").then((response) => {
        loadFiles(page_number, per_page_limit);
        setLoadingAnimation({
            ...loadingAnimation,
            massRestore: false,
    ...
    httpClient.put("/data/publish-all-csv-file").then((response) => {
        loadFiles(page_number, per_page_limit);
        setLoadingAnimation({
            ...loadingAnimation,
            massPublish: false,
    ...
    httpClient.put("/data/unpublished-all-csv-file").then((response) => {
        loadFiles(page_number, per_page_limit);
        setLoadingAnimation({
            ...loadingAnimation,
            massUnpublished: false,
