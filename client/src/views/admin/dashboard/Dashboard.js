...
import LoadingPage, {LoadingPageSkeletonImage, LoadingPageSkeletonText} from "../../../components/loading/LoadingPage";
...
export default function Dashboard() {
  ...
  const { loading_analysis, overall_sentiments, image_path_polarity_v_sentiment, image_path_review_length_v_sentiment, image_path_wordcloud, common_phrase, common_word, common_words} = analysis;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-6 pb-8">
              <div className="flex flex-col items-start w-full p-4 bg-blue-50 rounded-lg shadow space-y-2">
                ...
                {loading_analysis ? (
                  ...
                  overall_sentiments.map((overall) => (
                      <div className={`flex flex-col items-start justify-start w-full p-4 rounded-lg shadow ${overall.color50}`} key={overall.id}>
                        <div className="flex items-center justify-center">
                          <div
                              className={`flex items-center justify-center w-10 h-10 text-white rounded ${
                                  overall.color500
              ...
              <div className="flex flex-col items-start w-full p-4 bg-blue-50 rounded-lg shadow space-y-2">
                ...
                <div className="flex flex-col items-start justify-start w-full p-4 rounded-lg">
                  ...
                  <img alt="sentiment_v_pol" className="shadow rounded-lg" src={`data:image/jpeg;base64,${image_path_polarity_v_sentiment}`} />
                    )}
                </div>
              </div>
              <div className="flex flex-col items-start w-full p-4 bg-blue-50 rounded-lg shadow space-y-2">
                ...
                <div className="flex flex-col items-start justify-start w-full p-4 rounded-lg">
                  ...
                  <img alt="review_len_v_sentiment" className="shadow rounded-lg" src={`data:image/jpeg;base64,${image_path_review_length_v_sentiment}`} />
                    )}
                </div>
              </div>
              <div className="flex flex-col items-start w-full p-4 bg-blue-50 rounded-lg shadow space-y-2">
                ...
                <div className="flex flex-col items-start justify-start w-full p-4 rounded-lg">
                  ...
                  <img alt="wordcloud" className="shadow rounded-lg" src={`data:image/jpeg;base64,${image_path_wordcloud}`} />
                    )}
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 w-full pt-4">
                {loading_analysis ? (
                  ...
                  common_phrase.map((phrase) => (
                        <div className={`flex flex-col items-start w-full p-2 rounded-lg shadow space-y-2 ${phrase.sentiment === "1" ? "bg-green-50" : "bg-red-50"}`} key={phrase.id}>
                          <div className="flex justify-start w-full p-2 rounded-lg">
                            <div className="flex items-center justify-center">
                              <div
                                  className={`flex items-center justify-center w-10 h-10 text-white rounded ${phrase.sentiment === "1" ? "bg-green-500" : "bg-red-500"}`}
                              >
                                <i className={`${phrase.sentiment === "1" ? "fas fa-face-smile-beam" : "fas fa-face-frown"}`} />
                              </div>
                              <div className="flex flex-col items-start justify-center ml-4">
