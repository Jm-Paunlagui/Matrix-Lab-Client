  ...
  <div className="grid w-full h-full grid-cols-1 rounded md:grid-cols-5">
    <div className="col-span-2 p-8 bg-gray-50">
      ...
      <p className="mb-4 text-sm">
        Pick a CSV file to view the headers and select the columns required for
        the analysis.
      </p>
    </div>
      ...
      <form encType={"multipart/form-data"} onSubmit={handleSubmitCSVToView}>
        <div className="flex flex-col space-y-4">
          <div className="flex flex-col w-full space-y-2">
            ...
            <h1 className="text-base font-medium text-gray-500">CSV file</h1>
            <input
      ...
      {show_columns ? (
        <form onSubmit={handleSubmitToAnalyzeAndSave}>
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-col w-full space-y-2">
              <h1 className="text-base font-medium text-gray-500">File Name</h1>
              <input
                className={TEXT_FIELD}
                disabled
            ...
            <div className="flex flex-col w-full space-y-2">
              <h1 className="text-base font-medium text-gray-500">Sentence</h1>
              <Listbox
                name={"sentence"}
            ...
            <div className="flex flex-col w-full space-y-2">
              <h1 className="text-base font-medium text-gray-500">Evaluatee</h1>
              <Listbox
