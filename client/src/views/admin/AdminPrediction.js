...
export default function AdminPrediction() {
  ...
  const [selectedColumnForSentence, setSelectedColumnForSentence] =
    useState("Select Column");
  const [selectedColumnForEvaluatee, setSelectedColumnForEvaluatee] =
    useState("Select Column");
  const [selectedColumnForDepartment, setSelectedColumnForDepartment] =
    useState("Select Column");
  const [selectedColumnForCourse, setSelectedColumnForCourse] =
    useState("Select Column");
                  ...
                  <form>
                    <div className="flex flex-col space-y-4">
                      ...
                      <div className="flex flex-col w-full space-y-2">
                        ...
                        <Listbox
                          onChange={setSelectedColumnForSentence}
                          value={selectedColumnForSentence}
                        >
                          <div className="relative mt-1">
                            <Listbox.Button className={TEXT_FIELD}>
                              <span className="block truncate">
                                {selectedColumnForSentence}
                              </span>
                      ...
                      <div className="flex flex-col w-full space-y-2">
                        ...
                        <Listbox
                          onChange={setSelectedColumnForEvaluatee}
                          value={selectedColumnForEvaluatee}
                        >
                          <div className="relative mt-1">
                            <Listbox.Button className={TEXT_FIELD}>
                              <span className="block truncate">
                                {selectedColumnForEvaluatee}
                              </span>
                              <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
                                <ChevronUpDownIcon
                                  aria-hidden="true"
                      ...
                      <div className="flex flex-col w-full space-y-2">
                        ...
                        <Listbox
                          onChange={setSelectedColumnForDepartment}
                          value={selectedColumnForDepartment}
                        >
                          <div className="relative mt-1">
                            <Listbox.Button className={TEXT_FIELD}>
                              <span className="block truncate">
                                {selectedColumnForDepartment}
                              </span>
                              <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
                                <ChevronUpDownIcon
                                  aria-hidden="true"
                      ...
                      <div className="flex flex-col w-full space-y-2">
                        ...
                        <Listbox
                          onChange={setSelectedColumnForCourse}
                          value={selectedColumnForCourse}
                        >
                          <div className="relative mt-1">
                            <Listbox.Button className={TEXT_FIELD}>
                              <span className="block truncate">
                                {selectedColumnForCourse}
                              </span>
                              <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
                                <ChevronUpDownIcon
                                  aria-hidden="true"
