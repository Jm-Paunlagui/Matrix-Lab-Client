            ...
            <div className="grid w-full h-full grid-cols-1 rounded md:grid-cols-5">
              <div className="col-span-2 p-8 bg-gray-50">
                ...
                <p className="mb-4 text-sm">
                  ...
                  {" "}pick a header for the <b className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 via-teal-500 to-indigo-500">sentence</b>.
                </p>
                <p className="mb-4 text-sm">
                  <b className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 via-teal-500 to-indigo-500">sentence</b> {" "} is the header that contains the responses of the students.
                </p>
              </div>
                ...
                {show_columns ? (
                    <form onSubmit={handleSubmitToAnalyzeAndSave}>
                      <div className="flex flex-col space-y-4">
                        ...
                        <p className="">
                          Select the header that contains the responses to be analyzed. The responses should be in the form of a sentence. For example, &ldquo;I like the teacher&ldquo;.
                        </p>
                        <div className="flex flex-col w-full space-y-2">
                          <h1 className="text-base font-medium text-gray-500">
                            File Name
