...
export default function AdminPrediction() {
  ...
  const handleSubmitToAnalyzeAndSave = async (event) => {
    ...
    formData.append("selected_column_for_sentence", selected_column_for_sentence);
    formData.append("selected_column_for_evaluatee", selected_column_for_evaluatee);
    formData.append("selected_column_for_department", selected_column_for_department);
    formData.append("selected_column_for_course_code", selected_column_for_course_code);
    await httpClient
