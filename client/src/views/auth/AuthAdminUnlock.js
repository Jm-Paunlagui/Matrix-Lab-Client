...
import {AssociatedEmails, SendToEmail, Username, VerifyTFA} from "../../forms/CredentialForms";
...
export default function AuthAdminUnlock() {
    ...
    const {name, email, confirm_email, code, id1, id2, id3, textChange, textChange2, username, buttonDisabled, is_resend} = toUnlock;
    /**
    ...
    const handleEmailSubmit = async (event) => {
        ...
        await httpClient
            ...
            .then((response) => {
                ...
                setToUnlock({ ...toUnlock, textChange: "Continue", textChange2: "Resend Code" });
                setCountDown(30);
                if (count >= 4) {
                    setCount(count);
                } else {
        ...
        httpClient
            ...
            .then((res) => {
                if (res.data.status === "success") {
                    ...
                    toast.success(`Please verify your identity, ${res.data.user_data.name}`,{
                        position: "top-center",
                        width: "100%",
                    });
                }
                        ...
                        {ok ? (
                            <div className="py-12 bg-white rounded-lg shadow-lg">
                                ...
                                <div className="px-6 space-y-6 text-center text-gray-500">
                                    <p className="text-lg">
                                        We&#39;ve sent you an email with a new password. Please check your inbox.
                                    </p>
                                    <p className="text-lg">
                                    ...
                                    <div className="mb-3 text-start">
                                        {count === 1 ? (
                                            <p className="text-gray-500">
                                                Enter your username below {name} to verify your identity.
                                            </p>
                                        ) : count === 2 ? (
                                            <p className="text-gray-500">
                                                Choose an email address on which you want to receive the verification code.
                                            </p>
                                        ) : count === 3 ? (
                                            <p className="text-gray-500">
