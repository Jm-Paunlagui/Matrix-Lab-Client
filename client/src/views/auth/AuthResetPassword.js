                    ...
                    >
                        ...
                        {ok ? (
                            <div className="bg-white py-12 rounded-lg shadow-lg">
                                ...
                                <div className="text-center text-gray-500 px-6 space-y-6">
                                    <p className="text-lg">Your password has been reset successfully. You can now login with your new password.</p>
                                    <div className="flex flex-col justify-center">
                                        <button type={"button"} className={`${PRIMARY_BUTTON}`}>
                                            <Link to={"/auth"}>
                                                <h1 className="px-5 py-1">Proceed to
                                                    <FontAwesomeIcon
                                                        icon={faSignIn}
                        ...
                        <div className={"px-6 lg:px-28"}>
                            ...
                            <div className="flex-auto space-y-6 mb-24 -mt-14">
                                ...
                                <form className="relative mx-auto max-w-screen"
