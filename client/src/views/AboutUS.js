    ...
    <>
      ...
      <div className="items-center w-full h-full min-h-screen font-Montserrat">
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 font-Montserrat text-gray-200 justify-items-center">
          ...
          <hr />
          <h1 className="text-4xl font-extrabold leading-none tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-blue-500  md:text-5xl xl:text-6xl text-center py-16">
          ...
          <div className="flex flex-wrap items-top justify-center">
            <div className="grid grid-cols-1 gap-1 md:grid-cols-2 md:gap-4 lg:grid-cols-3 mb-24">
              {Technologies.map((technology, index) => (
                <div
                  key={index}
                  className="p-6 auto-cols-max h-full auto-rows-max bg-white flex flex-col w-full min-w-0 break-words border-0 rounded shadow place-items-center"
                >
                  {technology.logo ? (
                    <Icon
                  ...
                  <h1 className="text-xl font-extrabold leading-none tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-blue-500 text-center py-8">
                    {technology.name}{" "}
